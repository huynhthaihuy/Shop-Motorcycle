...
class PageController extends Controller
{
    ...
    public function index(){
        ...
        $new_product1 = Product::where('promotion_price','<>',0)->paginate(4);
        return view('Page.trangchu',compact('new_product','new_product1'));
    }
    public function adminControl(){
        $new_product = Product::where('new',1)->paginate(4);
        $new_product1 = Product::where('promotion_price','<>',0)->paginate(4);
        return view('Page.adminpage',compact('new_product','new_product1'));
    }
    ...
    public function postLogin(Request $request){
        ...
        $password = $request->password;
            ...
            return redirect()->route('users.admincontrol');
            }
